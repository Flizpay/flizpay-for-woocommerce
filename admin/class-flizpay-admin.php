	...
	public function load_form_fields()
	{
		return array(
			...
			'flizpay_enable_express_checkout' => array(
				...
				'default' => 'yes',
				'description' => $this->is_english()
					? 'When dealing with flat and non-taxable shipping fees, make sure the taxable option is set to “false” in the WooCommerce Shipping Zone Settings (WooCommerce > Settings > Shipping). Otherwise, the total cost calculation during express checkout may incur in taxes being applied to shipping fees.'
					: 'Beim Umgang mit pauschalen und nicht steuerpflichtigen Versandkosten stelle sicher, dass die Steueroption in den WooCommerce-Versandzonen-Einstellungen (WooCommerce > Einstellungen > Versand) auf „falsch“ gesetzt ist. Andernfalls kann es bei der Berechnung der Gesamtkosten während des Express-Checkouts zu Steuern auf die Versandkosten kommen.'
			),
