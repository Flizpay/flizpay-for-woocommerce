		...
		return <<<HTML
			...
			<div style="background-color: #f7f7f7; margin-bottom: 20px; padding: 20px; border-left: 4px solid #007cba;">
				...
				<ol>
					...
					<li>Once you signed up, please generate a new <strong>API Key</strong> in your FLIZ company account and paste it in the “API KEY” field below.</li>
					<li>Click the button <strong>Connect to FLIZpay</strong></li>
					<li>Wait about 5 seconds and the page will reload automatically.</li>
					<li>After the page reload, a green box is shown at the bottom, indicating the successful configuration of the FLIZpay plugin. You are now ready to receive fee-free payments.</li>
					...
					<li>Clicking on “Save changes” on the bottom left is optional.</li>
				</ol>
