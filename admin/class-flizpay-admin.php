	...
	public function load_form_fields()
	{
		return array(
			...
			'flizpay_enabled' => array(
				'title' => 'Ermöglicht<br><p style="font-style: italic;">Enabled</p>',
			...
			'flizpay_api_key' => array(
				...
				'label' => 'Enter API KEY',
				'type' => 'password',
				'description' => 'Gib deinen API KEY ein.  Der API KEY ist ein sensibler Datensatz und sollte wie ein Passwort behandelt werden.<br>
				<p style="font-style: italic;">Enter you API KEY. This information is very sensitive, it should be treated as a password.</p>',
				'desc_tip' => false,
			),
			...
			'flizpay_webhook_alive' => array(
				'title' => 'Verbindung hergestellt.<br><p style="font-style: italic;">Connection Stablished</p>',
				'type' => 'checkbox',
		...
		return <<<HTML
			<div class='flizpay-description-banner'>
				<div class="flizpay-german-banner">
					...
					<p>Anleitung:</p>
					<ol>
						<li>Wenn du noch kein FLIZ-Firmenkonto hast, klicke bitte <a href='app.flizpay.de' target='_blank'>hier</a> und registriere dich jetzt.</li>
						...
						<li>Stelle sicher, dass du mit FLIZ so viele Gebühren wie möglich sparst. Vergiss also nicht, FLIZpay in der für Kunden zur Auswahl stehenden Liste an Zahlungsmethoden an die erste Stelle zu setzen. Das kannst du durch auf deiner WordPress-Admin Seite. Klicke im linken Menü auf “WooCommerce”, dann im Untermenü auf “Einstellungen”. Klicke anschließend im Menü oben auf den Tab “Zahlungen”. Auf dieser Seite kannst du per Drag-and-Drop oder mit den Pfeilen die Position von FLIZpay in der Liste der verfügbaren Zahlungsmethoden anpassen. Klicke zum Schluss unten links auf “Änderungen speichern”.</li>
						<li>Darüber hinaus empfehlen wir dir, Cashback für deine Kunden zu aktivieren. Ändere das Zahlungsverhalten deiner Kunden, damit sie FLIZ nutzen - denn FLIZ ist gebührenfrei. Um das zu erreichen, kannst du einen prozentualen Cashback festlegen, der als Rabatt von jedem Einkauf abgezogen wird, den deine Kunden mit FLIZ tätigen. Je mehr Cashback du gibst, desto höher wird der Anteil von FLIZ an deiner Kasse, was bedeutet, dass deine Kundenbasis zu einer gebührenfreien Zahlungsmethode gewechselt ist. Du kannst Cashback in deinem FLIZ-Firmenkonto aktivieren, <a href='app.flizpay.de' target='_blank'>klicke hier.</a></li>
					</ol>
				...
				<div class="flizpay-english-banner">
					...
					<p>Instructions:</p>
					<ol>
						<li>If you haven’t signed up for a FLIZ company account, please <a href='app.flizpay.de' target='_blank'>click here</a> and sign up.</li>
