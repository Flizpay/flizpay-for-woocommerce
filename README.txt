...
= v2.6.0 =
* Added   - Secure one-click pairing from the FLIZpay merchant dashboard.
* Added   - Connection-scoped credentials, so a paired shop never holds a full account API key.
* Added   - Temporary WordPress Application Passwords are revoked once installation finishes.
